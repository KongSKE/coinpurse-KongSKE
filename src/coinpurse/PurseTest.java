...
public class PurseTest {
	...
	public void insertBankCoinAndGetBalance() {
		...
		Valuable coin1 = makeCoin(25);
		Valuable coin2 = makeCoin(20);
		Valuable coin3 = makeCoin(3);
		Valuable coin4 = makeCoin(1);
		assertTrue(purse.insert(coin1));
		assertTrue(purse.insert(coin3));
		assertTrue(purse.insert(coin2));
		...
		// purse is full so insert should fail
		assertFalse(purse.insert(makeCoin(1)));
		assertEquals(purse.getBalance(), 49.0, TOL);
	}
	...
	public void easyWithdrawBankCoin() {
		Purse purse = new Purse(10);
		double[] values = { 1, 20, 28, 46 }; // values of coins we will insert
